...
class Trainer:
    ...
    def sample_neg(self, forbidden):
        # TODO 1.2: Obtén una muestra negativa de tokens, evitando seleccionar aquellos en 
    ...
    def train(self):
        ...
        # Para cada token en el contexto del token actual, es decir, para cada 
            #   token dentro de los `self.window_size` tokens a la derecha e izquieda del actual, sin contar este:
        ...
        # TODO 4: Usa una ventana de contexto dinámica, con tamaños que varíen aleatoriamente 
